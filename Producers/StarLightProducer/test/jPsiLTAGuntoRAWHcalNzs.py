...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(int(sys.argv[3]))
)
...
process.generator = cms.EDProducer("Pythia6PtYDistGun",
	...
	kinematicsFile = cms.FileInPath('Producers/StarLightProducer/data/jpsi'+sys.argv[4]+'UpcFlatY.root'),
	PtBinning = cms.int32(100000),
	YBinning = cms.int32(500),
        MinPhi = cms.double(-3.14159265359),
        MaxPhi = cms.double(3.14159265359),
        MinPt = cms.double(0.0),
        MaxPt = cms.double(1.5),
        MinY = cms.double(-2.6),
        MaxY = cms.double(2.6)
    ),
