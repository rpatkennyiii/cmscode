...
char* draw="posEM1ADC:Iteration$";
char* selection="";
char* title="ZDC Laser Run:181007 PZDC-EM1";
char* draw1="negEM1ADC:Iteration$";
char* selection1="";
...
char* draw2="posHD1ADC:Iteration$";
char* draw3="negHD1ADC:Iteration$";
char* selection2="";
char* selection3="";
  ...
  if(j==0){
    for ( int i = 1 ; i < 6;i++) 
   {
    ...
    for (int i = 1 ; i < 6; i++) 
     {
    if (i<=4){
       NZDC[i+4]=new TH2F(title3,title3,10,0,10,128,0,128);
