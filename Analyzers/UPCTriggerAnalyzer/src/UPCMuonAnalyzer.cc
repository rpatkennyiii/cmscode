	...
	if(!muons.failedToGet()){
		for(unsigned int i=0; i<(*muons).size();i++){
			...
			if(((*muons)[i]).isTrackerMuon()&&nTrackerMuon<100){
				...
				getTrack(((*muons)[i].track()).get(),ndofTracker[nTrackerMuon],chi2Tracker[nTrackerMuon],numberOfValidTrackerHitsTracker[nTrackerMuon],pixelLayersWithMeasurementTracker[nTrackerMuon],xTracker[nTrackerMuon],yTracker[nTrackerMuon],zTracker[nTrackerMuon],pTracker[nTrackerMuon],qoverpTracker[nTrackerMuon],lambdaTracker[nTrackerMuon],phiTracker[nTrackerMuon],varQoverpTracker[nTrackerMuon],varLambdaTracker[nTrackerMuon],varPhiTracker[nTrackerMuon],
...
void UPCMuonAnalyzer::getTrack(const Track *trax, unsigned int &ndof, float &chi2, unsigned int &vHits, unsigned int &pixHits,
