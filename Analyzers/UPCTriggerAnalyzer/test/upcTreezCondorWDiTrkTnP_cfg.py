...
process.load("Analyzers.UPCTriggerAnalyzer.upcTnPTreesPPb_cff")
...
process.upcpatmuana = cms.EDAnalyzer('UPCMuonAnalyzer',
	muonLabel=cms.InputTag("trackCands")
)
