...
if len(sys.argv) > 2:
	...
	process.triggerSelection = cms.EDFilter( "TriggerResultsFilter",
		 triggerConditions = cms.vstring("( HLT_HIMinBiasZDC_Calo_PlusOrMinus_v1 OR HLT_HIMinBiasZDC_PlusOrMinusPixel_SingleTrack_v1 ) AND ( NOT L1_BscMinBiasThreshold2_BptxAND )"),
