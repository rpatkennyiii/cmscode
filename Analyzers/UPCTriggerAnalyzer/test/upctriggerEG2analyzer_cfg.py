...
#    		triggerConditions = cms.vstring("( L1_ZdcCaloPlus_BptxAND OR L1_ZdcCaloMinus_BptxAND ) AND ( NOT L1_BscMinBiasThreshold1 ) AND (L1_SingleEG2) AND (HLT_HIZeroBiasPixel_SingleTrack)"),
    		triggerConditions = cms.vstring("(HLT_HIZeroBias)"),
