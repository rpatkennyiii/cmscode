#define GPTrackTree_cxx
#include "GPTrackTree.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void GPTrackTree::Loop()
{
   if (fChain == 0) return;
...
void GPTrackTree::SubLoop(Int_t nentries, TClonesArray *track4vec, double *p, double *lambda, double *phi) 
{
   double px,py,pz,E,m=mass; // mass in GeV
